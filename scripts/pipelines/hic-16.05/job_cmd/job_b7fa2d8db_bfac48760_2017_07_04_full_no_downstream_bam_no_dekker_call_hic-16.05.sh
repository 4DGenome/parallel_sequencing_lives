#!/bin/bash
#$ -N job_b7fa2d8db_bfac48760_2017_07_04_full_no_downstream_bam_no_dekker_call_hic-16.05
#$ -q long-sl7
#$ -l virtual_free=100G
#$ -l h_rt=100:00:00
#$ -o /users/GR/mb/jquilez/projects/parallel_sequencing_lives/scripts/pipelines/hic-16.05/job_out/job_b7fa2d8db_bfac48760_2017_07_04_full_no_downstream_bam_no_dekker_call_hic-16.05_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/projects/parallel_sequencing_lives/scripts/pipelines/hic-16.05/job_out/job_b7fa2d8db_bfac48760_2017_07_04_full_no_downstream_bam_no_dekker_call_hic-16.05_$JOB_ID.err
#$ -j y
...
path_job_file=/users/GR/mb/jquilez/projects/parallel_sequencing_lives/scripts/pipelines/hic-16.05/job_cmd/job_b7fa2d8db_bfac48760_2017_07_04_full_no_downstream_bam_no_dekker_call_hic-16.05.sh
