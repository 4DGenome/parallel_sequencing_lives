#!/bin/bash
#$ -N job_b7fa2d8db_bfac48760_2017_06_29_full_no_downstream_bam_no_dekker_call_hic-16.05
#$ -q long-sl7
#$ -l virtual_free=100G
#$ -l h_rt=100:00:00
#$ -o /users/GR/mb/jquilez/projects/parallel_sequencing_lives/scripts/pipelines/hic-16.05/job_out/job_b7fa2d8db_bfac48760_2017_06_29_full_no_downstream_bam_no_dekker_call_hic-16.05_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/projects/parallel_sequencing_lives/scripts/pipelines/hic-16.05/job_out/job_b7fa2d8db_bfac48760_2017_06_29_full_no_downstream_bam_no_dekker_call_hic-16.05_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 10

submitted_on=2017_06_29
pipeline_version=16.05
sample_id=b7fa2d8db_bfac48760
data_type=hic
pipeline_name=hic
pipeline_version=16.05
...
path_job_file=/users/GR/mb/jquilez/projects/parallel_sequencing_lives/scripts/pipelines/hic-16.05/job_cmd/job_b7fa2d8db_bfac48760_2017_06_29_full_no_downstream_bam_no_dekker_call_hic-16.05.sh
